...
<body>
    ...
    <div class="container-fluid " style="height: 600px;">
        ...
        <Div class="card shadow p-3 shadow d-flex justify-content-center align-items-center" style="border: none; background-color: #DCF1FF;">
            <div class="card w-50 shadow h-50 d-flex justify-content-center align-items-center" style="border: none; background-color: #9AC9DF;">
                <div class="card-body">
                    <h5 class="card-title fs-2 text-center">
                        <?php
                        if ($total) {
                    ...
                    <p class="card-text text-center">Your Current Active Plan</p>
                </div>
            </div>
        </Div>
    </div>
